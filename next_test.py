...
def train_price_volume_sliding_window(network, training_set, data_dimension=2, price_index=0, history_interval=5,
                                      prediction_interval=5):
    trainer = RPropMinusTrainer(network, verbose=True, batchlearning=True, learningrate=0.01, lrdecay=0.0, momentum=0.0,
                                weightdecay=0.0)
